        ...
        <div className="side-by-side-container">
          ...
          <div className="bulleted-info">
            <Typography className= "general-text" variant="h4">
              Once you boot up the Simulation, you will be greeted by the main desktop. You can select the spectrometer to add chemicals.
            </Typography>
          </div>
        </div>

        <Box display="flex" justifyContent="right" m={0}>
          <Button variant="contained" color="primary" endIcon={<NavigateNext/>} component={Link} to="/gettingStarted/1">
            Next
          </Button>
        </Box>
      </div>
