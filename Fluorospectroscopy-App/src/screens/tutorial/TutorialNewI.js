    ...
    <>
      ...
      <div className="tutorial-body">
        <Typography className= "general-text" variant="h3" color="secondary">
          What does the emission bandwidth affect?
        </Typography>
      ...
      <Popup ref={correctRef} modal>
        <div className="popup-correct">
          <Typography variant="h4" color="secondary">
            That's right! The detector will allow a different amount of light depending on the emission bandwidth.
          </Typography>
          <Box display="flex" justifyContent="right" m={2}>
            <Button variant="contained" color="primary" endIcon={<NavigateNext/>} component={Link} to="/tutorial/9">
              Next
            </Button>
          </Box>
        </div>
